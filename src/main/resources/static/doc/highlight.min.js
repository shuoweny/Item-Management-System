...
const hljs = (function () {
  ...
  const Y = ((e) => {
      ...
      function N(n, s) {
        ...
        if (((y = s), "begin" === s.type))
          return ((e) => {
            ...
            const t = e.rule;
            const i = new a(t);
            const s = [t.__beforeBegin, t["on:begin"]];
            for (const t of s)
    ...
    function p(e) {
      ...
      const s = t ? u(a, { language: t, ignoreIllegals: !0 }) : m(a);
      (e.innerHTML = s.value),
        ((e, n, t) => {
          const a = (n && i[n]) || t;
  ...
  const re = ae.concat(ie);
  const oe = "\\.([0-9](_*[0-9])*)";
  const le = "[0-9a-fA-F](_*[0-9a-fA-F])*";
  const ce = {
    className: "number",
    variants: [
      {
  ...
  const be = ["true", "false", "null", "undefined", "NaN", "Infinity"];
  const me = [
    "Intl",
    "DataView",
    "Number",
  ...
  function Ee(e) {
    ...
    const i = "\\.([0-9](_?[0-9])*)";
    const s = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*";
    const r = {
      className: "number",
      variants: [
        {
  ...
  const Ne = ["Protocol", "Type"].map(ye);
  const we = ["init", "self"].map(ye);
  const ve = ["Any", "Self"];
  const Oe = [
    "actor",
    "associatedtype",
  ...
  const ze = Object.freeze({
    ...
    grmr_c: (e) => {
      ...
      const g = [o, i, n, e.C_BLOCK_COMMENT_MODE, r, s];
      const b = {
        variants: [
          { begin: /=/, end: /;/ },
          {
    ...
    grmr_cpp: (e) => {
      ...
      const p = [m, o, i, n, e.C_BLOCK_COMMENT_MODE, r, s];
      const _ = {
        variants: [
          { begin: /=/, end: /;/ },
          {
    ...
    grmr_csharp: (e) => {
      ...
      const s = e.inherit(i, { illegal: /\n/ });
      const r = { className: "subst", begin: /\{/, end: /\}/, keywords: n };
      const o = e.inherit(r, { illegal: /\n/ });
      const l = {
        className: "string",
        begin: /\$"/,
        end: '"',
    ...
    grmr_css: (e) => {
      const n = ee(e);
      const t = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE];
      return {
        name: "CSS",
        case_insensitive: !0,
        illegal: /[=|'\$]/,
    ...
    grmr_ini: (e) => {
      ...
      const i = { className: "literal", begin: /\bon|off|true|false|yes|no\b/ };
      const s = {
        className: "string",
        contains: [e.BACKSLASH_ESCAPE],
        variants: [
    ...
    grmr_less: (e) => {
      ...
      const o = (e, n, t) => ({ className: e, begin: n, relevance: t });
      const l = {
        $pattern: /[a-z-]+/,
        keyword: "and or not only",
        attribute: te.join(" "),
    ...
    grmr_xml: (e) => {
      ...
      const s = e.inherit(e.APOS_STRING_MODE, { className: "string" });
      const r = e.inherit(e.QUOTE_STRING_MODE, { className: "string" });
      const o = {
        endsWithParent: !0,
        illegal: /</,
        relevance: 0,
    ...
    grmr_perl: (e) => {
      ...
      const r = [e.BACKSLASH_ESCAPE, a, s];
      const o = [/!/, /\//, /\|/, /\?/, /'/, /"/, /#/];
      const l = (e, t, a = "\\1") => {
        const i = "\\1" === a ? a : b(a, t);
        return b(
    ...
    grmr_php: (e) => {
      ...
      const i = e.inherit(e.APOS_STRING_MODE, { illegal: null });
      const s = e.inherit(e.QUOTE_STRING_MODE, {
        illegal: null,
        contains: e.QUOTE_STRING_MODE.contains.concat(a),
      });
      const r = e.END_SAME_AS_BEGIN({
        begin: /<<<[ \t]*(\w+)\n/,
        end: /[ \t]*(\w+)\b/,
        contains: e.QUOTE_STRING_MODE.contains.concat(a),
      });
    ...
    grmr_ruby: (e) => {
      ...
      const r = { className: "subst", begin: /#\{/, end: /\}/, keywords: t };
      const o = {
        className: "string",
    ...
    grmr_swift: (e) => {
      ...
      const i = { match: [/\./, m(...Ne, ...we)], className: { 2: "keyword" } };
      const s = { match: b(/\./, m(...Oe)), relevance: 0 };
      const r = Oe.filter((e) => "string" == typeof e).concat(["_|0"]);
      const o = {
        variants: [
          {
            className: "keyword",
      ...
      const C = { begin: /</, end: />/, contains: [...a, S] };
      const T = {
        begin: /\(/,
        end: /\)/,
        keywords: l,
    ...
    grmr_vbnet: (e) => {
      ...
      const t = /\d{4}-\d{1,2}-\d{1,2}/;
      const a = /(\d|1[012])(:\d+){0,2} *(AM|PM)/;
      const i = /\d{1,2}(:\d{1,2}){1,2}/;
      const s = {
        className: "literal",
        variants: [
          { begin: b(/# */, m(t, n), / *#/) },
